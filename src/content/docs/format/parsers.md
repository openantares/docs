...
conformance/golden/basic.ant: OK  version=0.6 records=7 skipped=0 counts={'schemaTypes': 0, 'vertices': 2, 'edges': 1, 'observations': 1, 'evidence': 1, 'beliefs': 1, 'vectors': 1, 'vertexTombstones': 0, 'edgeTombstones': 0, 'contradictionCases': 0, 'relationshipProposals': 0}
$ echo $?
0
```
...
Both bindings pass the full [conformance suite](../conformance/), including the negative fixtures, and both flag a file whose minor version is ahead of them rather than guessing.
